...
final List<Ingredient> ingredientMock = [
  Ingredient(
      id: 1,
      product:
          productsMock.singleWhere((element) => element.name.pl == 'Banan'),
      description: null,
  ...
  Ingredient(
      id: 2,
      product:
          productsMock.singleWhere((element) => element.name.pl == 'Mleko'),
      description: null,
  ...
  Ingredient(
      id: 4,
      product:
          productsMock.singleWhere((element) => element.name.pl == 'Pieprz'),
      description: null,
